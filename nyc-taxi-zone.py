...
from bokeh.models import GeoJSONDataSource, LinearColorMapper,LogColorMapper, ColorBar, NumeralTickFormatter, Slider, HoverTool, Select, Column
...
from bokeh.tile_providers import STAMEN_TERRAIN_RETINA,STAMEN_TONER, get_provider
...
def make_plot(field_name, new_data):    
    ...
    p = figure(title = verbage + ' - NYC in 2020',
             ...
             plot_height = 850, plot_width = 850,
...
#output_file('frontpage_plot.html')
#save(p)
